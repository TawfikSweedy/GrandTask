...
public class ZVActivityIndicatorView: UIView {
    ...
    override public init(frame: CGRect) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(ZVActivityIndicatorView.resetAnimating), name: NSNotification.Name.NSExtensionHostDidBecomeActive , object: nil)
    }
    ...
    deinit {
        NotificationCenter.default.removeObserver(NSNotification.Name.NSExtensionHostDidBecomeActive)
    }
