...
open class ZVRefreshComponent: UIControl {
    ...
    public func checkState(_ state: RefreshState) -> (result: Bool, oldState: RefreshState) {
...
extension ZVRefreshComponent {
    ...
    fileprivate func _removeObservers() {
        ...
        self.scrollView?.removeObserver(self, forKeyPath: ConfigZZZ.KeyPath.contentOffset)
        self.scrollView?.removeObserver(self, forKeyPath: ConfigZZZ.KeyPath.contentSize)
        self.scrollView?.removeObserver(self, forKeyPath: ConfigZZZ.KeyPath.panState)
    ...
    override open func observeValue(forKeyPath keyPath: String?,
        ...
        if keyPath == ConfigZZZ.KeyPath.contentSize {
            self.scrollViewContentSizeDidChanged(change)
        }

        guard self.isHidden == false else { return }

        if keyPath == ConfigZZZ.KeyPath.contentOffset {
            self.scrollViewContentOffsetDidChanged(change)
        } else if keyPath == ConfigZZZ.KeyPath.panState {
